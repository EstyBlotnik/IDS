...
from core.rules import detect_command_injection,detect_directory_traversal
from core.rules import detect_sql_injection
...
def analyze_packet(packet):
    ...
    if detect_command_injection(packet):
        alert("Command Injection attempt detected!", packet)
    if detect_directory_traversal(packet):
        alert("Directory Traversal attempt detected!", packet)
